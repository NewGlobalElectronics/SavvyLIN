...
MainSettingsDialogLIN::MainSettingsDialogLIN(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::MainSettingsDialogLIN)
{
    QSettings settings;
    ui->setupUi(this);
    ...
    ui->cbIgnoredbColors->setChecked(settings.value("Main/IgnoredbColors", false).toBool());
    ...
    connect(ui->cbIgnoredbColors, SIGNAL(toggled(bool)), this, SLOT(updateSettings()));
...
MainSettingsDialogLIN::~MainSettingsDialogLIN()
{
    delete ui;
}

void MainSettingsDialogLIN::closeEvent(QCloseEvent *event)
{
    Q_UNUSED(event);
...
bool MainSettingsDialogLIN::eventFilter(QObject *obj, QEvent *event)
{
...
void MainSettingsDialogLIN::updateSettings()
{
    QSettings settings;
    ...
    settings.setValue("Main/IgnoredbColors", ui->cbIgnoredbColors->isChecked());
