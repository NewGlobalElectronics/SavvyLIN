...
FirmwareUploaderWindowLIN::FirmwareUploaderWindowLIN(const QVector<LINFrame> *frames, QWidget *parent) :
    QDialog(parent),
    ui(new Ui::FirmwareUploaderWindowLIN)
{
    ui->setupUi(this);
...
FirmwareUploaderWindowLIN::~FirmwareUploaderWindowLIN()
{
    timer->stop();
...
void FirmwareUploaderWindowLIN::gotTargettedFrame(LINFrame frame)
{
...
void FirmwareUploaderWindowLIN::timerElapsed()
{
    sendFirmwareChunk(); //resend
}

void FirmwareUploaderWindowLIN::sendFirmwareChunk()
{
    LINFrame output;
...
void FirmwareUploaderWindowLIN::sendFirmwareEnding()
{
    LINFrame output;
    output.setExtendedFrameFormat(false);
    output.bus = bus;
...
void FirmwareUploaderWindowLIN::handleStartStopTransfer()
{
...
void FirmwareUploaderWindowLIN::handleLoadFile()
{
    QFileDialog dialog;
...
void FirmwareUploaderWindowLIN::loadBinaryFile(QString filename)
{
