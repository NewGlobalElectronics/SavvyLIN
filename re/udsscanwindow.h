...
namespace Ui {
class UDSScanWindowLIN;
}

class UDSScanWindowLIN : public QDialog
{
    Q_OBJECT

public:
    explicit UDSScanWindowLIN(const QVector<LINFrame> *frames, QWidget *parent = 0);
    ~UDSScanWindowLIN();
