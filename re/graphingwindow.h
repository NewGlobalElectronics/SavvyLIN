...
class GraphingWindowLIN : public QDialog
{
    Q_OBJECT

public:
    explicit GraphingWindowLIN(const QVector<LINFrame> *, QWidget *parent = 0);
    ~GraphingWindowLIN();
...
private slots:
    ...
    void addNewGraph();    
    void appendToGraph(GraphParams &params, LINFrame &frame, QVector<double> &x, QVector<double> &y);
