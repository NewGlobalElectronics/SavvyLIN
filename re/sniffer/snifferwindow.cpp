...
SnifferWindowLIN::SnifferWindowLIN(QWidget *parent) :
    QDialog(parent),
    ...
    mFilter(false)
{
    ...
    /* connect timer */
    connect(&mGUITimer, &QTimer::timeout, this, &SnifferWindowLIN::update);
    mGUITimer.setInterval(200);
    connect(&mNotchTimer, &QTimer::timeout,this, &SnifferWindowLIN::notchTick);
    ...
    connect(ui->btAll, &QPushButton::clicked, this, &SnifferWindowLIN::fltAll);
    connect(ui->btNone, &QPushButton::clicked, this, &SnifferWindowLIN::fltNone);
    connect(&mModel, &SnifferModel::idChange, this, &SnifferWindowLIN::idChange);
    connect(ui->listWidget, &QListWidget::itemChanged, this, &SnifferWindowLIN::itemChanged);
...
SnifferWindowLIN::~SnifferWindowLIN()
{
    closeEvent(nullptr);
    delete sniffDel;
    delete ui;
...
void SnifferWindowLIN::readSettings()
{
    QSettings settings;
...
void SnifferWindowLIN::writeSettings()
{
    QSettings settings;
...
void SnifferWindowLIN::showEvent(QShowEvent* event)
{
...
void SnifferWindowLIN::closeEvent(QCloseEvent *event)
{
    Q_UNUSED(event);
    /* stop timer */
    mGUITimer.stop();
...
bool SnifferWindowLIN::eventFilter(QObject *obj, QEvent *event)
{
...
void SnifferWindowLIN::update()
{
    mModel.refresh();
}

void SnifferWindowLIN::notchTick()
{
...
void SnifferWindowLIN::fltAll()
{
    filter(false);
}


void SnifferWindowLIN::fltNone()
{
    filter(true);
}

void SnifferWindowLIN::filter(bool pFilter)
{
    mFilter = pFilter;
...
void SnifferWindowLIN::idChange(int pId, bool pAdd)
{
...
void SnifferWindowLIN::itemChanged(QListWidgetItem * item)
{
