...
TemporalGraphWindowLIN::TemporalGraphWindowLIN(const QVector<LINFrame> *frames, QWidget *parent) :
    QDialog(parent),
    ui(new Ui::TemporalGraphWindowLIN)
{
    ui->setupUi(this);
...
TemporalGraphWindowLIN::~TemporalGraphWindowLIN()
{
    delete ui;
}

void TemporalGraphWindowLIN::showEvent(QShowEvent* event)
{
...
void TemporalGraphWindowLIN::closeEvent(QCloseEvent *event)
{
    Q_UNUSED(event);
...
void TemporalGraphWindowLIN::readSettings()
{
    QSettings settings;
...
void TemporalGraphWindowLIN::writeSettings()
{
    QSettings settings;
...
void TemporalGraphWindowLIN::updatedFrames(int numFrames)
{
    LINFrame thisFrame;
    QVector<double> x, y;
...
void TemporalGraphWindowLIN::generateGraph()
{
...
void TemporalGraphWindowLIN::selectionChanged()
{
  /*
...
void TemporalGraphWindowLIN::mousePress()
{
...
void TemporalGraphWindowLIN::mouseWheel()
{
   qDebug() << "Mouse WHeel";
...
bool TemporalGraphWindowLIN::eventFilter(QObject *obj, QEvent *event)
{
...
void TemporalGraphWindowLIN::resetView()
{
    ui->graphingView->xAxis->setRange(xminval, xmaxval);
    ui->graphingView->yAxis->setRange(yminval, ymaxval);
    ui->graphingView->axisRect()->setupFullAxesBox();
...
void TemporalGraphWindowLIN::zoomIn()
{
...
void TemporalGraphWindowLIN::zoomOut()
{
    QCPRange xrange = ui->graphingView->xAxis->range();
    QCPRange yrange = ui->graphingView->yAxis->range();
    if (ui->graphingView->xAxis->selectedParts().testFlag(QCPAxis::spAxis))
