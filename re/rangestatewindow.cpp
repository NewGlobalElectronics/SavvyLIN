...
RangeStateWindowLIN::RangeStateWindowLIN(const QVector<LINFrame> *frames, QWidget *parent) :
    QDialog(parent),
    ui(new Ui::RangeStateWindowLIN)
{
    ui->setupUi(this);
...
//unfortunately the fact that valueChanged is overloaded makes the syntax here HORRIBLE. That sucks.
    ...
    connect(ui->btnRecalc, &QAbstractButton::clicked, this, &RangeStateWindowLIN::recalcButton);
    connect(MainWindow::getReference(), SIGNAL(framesUpdated(int)), this, SLOT(updatedFrames(int)));
    connect(ui->listCandidates, &QListWidget::currentRowChanged, this, &RangeStateWindowLIN::clickedSignalList);
}

RangeStateWindowLIN::~RangeStateWindowLIN()
{
    delete ui;
}

void RangeStateWindowLIN::showEvent(QShowEvent* event)
{
...
void RangeStateWindowLIN::closeEvent(QCloseEvent *event)
{
    Q_UNUSED(event);
...
bool RangeStateWindowLIN::eventFilter(QObject *obj, QEvent *event)
{
...
void RangeStateWindowLIN::readSettings()
{
    QSettings settings;
...
void RangeStateWindowLIN::writeSettings()
{
    QSettings settings;
...
void RangeStateWindowLIN::updatedFrames(int numFrames)
{
    LINFrame thisFrame;
...
void RangeStateWindowLIN::refreshFilterList()
{
    int id;
...
void RangeStateWindowLIN::recalcButton()
{
...
*/
void RangeStateWindowLIN::signalsFactory()
{
...
*/
bool RangeStateWindowLIN::processSignal(int startBit, int bitLength, int sensitivity, bool bigEndian, bool isSigned)
{
    qDebug() << "";
...
void RangeStateWindowLIN::createGraph(QVector<int> values)
{
...
void RangeStateWindowLIN::clickedSignalList(int idx)
{
