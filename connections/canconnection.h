...
signals:
     ...
     */
    void targettedFrameReceived(LINFrame frame);
...
protected:
    ...
    void checkTargettedFrame(LINFrame &frame);
...
protected:
     ...
     * @return false if parameter is invalid (bus id for instance)
     */
    virtual bool piSendFrame(const LINFrame&) = 0;
     ...
     */
    virtual bool piSendFrames(const QList<LINFrame>&);
