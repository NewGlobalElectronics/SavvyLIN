...
void ISOTP_HANDLER::rapidFrames(const CANConnection* conn, const QVector<LINFrame>& pFrames)
{
    Q_UNUSED(conn)
    ...
    foreach(const LINFrame& thisFrame, pFrames)
    {
...
void ISOTP_HANDLER::processFrame(const LINFrame &frame)
{
