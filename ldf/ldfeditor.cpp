...
LDFEditor::LDFEditor(std::string omstrLdfPath, QWidget* parent)
    : QMainWindow(parent) {
  qWarning() << "LDFEditor constructor called";
  QList<int> sizeList;
  sizeList << 25 << 150 << 25;
...
void LDFEditor::closeEvent(QCloseEvent* event) {
     qWarning() << "closeEvent function called";
  if (CheckForSaving() == 0) {
    event->ignore();
  } else {
    event->accept();
...
void LDFEditor::OnDocumentModified() {
    qWarning() << "OnDocumentModified function called";
  bool bModified =
...
void LDFEditor::OnitemNetworkViewSelected() {
     qWarning() << "OnitemNetworkViewSelected function called";
...
void LDFEditor::OnitemElementViewSelected() {
    qWarning() << "OnitemElementViewSelected function called";
...
int LDFEditor::ConnectMenuActions(void) {
    qWarning() << "ConnectMenuActions function called";
  QIcon newIcon;
...
int LDFEditor::onFileExit() {
     qWarning() << "onFileExit function called";
  if (CheckForSaving() != 0) {
    QApplication::quit();
  }
...
int LDFEditor::onActionOpenRecentFile() {
         qWarning() << "onActionOpenRecentFile function called";
  if (CheckForSaving() == 0) {
    return 0;
  }
...
int LDFEditor::UpdatedRecentFileList() {
     qWarning() << "UpdatedRecentFileList function called";
...
int LDFEditor::onActionAbout() {
    qWarning() << "onActionAbout function called";
...
int LDFEditor::onActionHelp(void) {
      qWarning() << "onActionHelp function called";
...
int LDFEditor::onActionFileOpen(void) {
      qWarning() << "onActionFileOpen function called";
  if (CheckForSaving() == 0) {
    return 0;
  }
...
int LDFEditor::CloseCurrentLDFFile() {
  qWarning() << "CloseCurrentLDFFile function called";
...
int LDFEditor::OpenLDFFile(QString strLDFFilePath) {
     qWarning() << "OpenLDFFile function called";
  if ("" != strLDFFilePath) {
    CloseCurrentLDFFile();
...
int LDFEditor::OnFileLoad(QString strLDFFilePath) {
      qWarning() << "OnFileLoad function called";
...
int LDFEditor::CheckForSaving() {
      qWarning() << "CheckForSaving function called";
...
void LDFEditor::setTitle() {
     qWarning() << "setTitle function called";
...
int LDFEditor::onActionFileSave(void) {
     qWarning() << "onActionFileSave function called";
...
int LDFEditor::ValidateForSaving() {
    qWarning() << "ValidateForSaving function called";
  int nRet = 0;
  list<ParsingResults> ouErrors;
  list<ParsingResults> ouWarnings;
  m_pWarningTable->setRowCount(0);
...
int LDFEditor::onActionFileSaveAs(void) {
        qWarning() << "onActionFileSaveAs function called";
...
int LDFEditor::onActionLIN1_3(void) {
        qWarning() << "onActionLIN1_3 function called";
  if (CheckForSaving() == 0) {
    return 0;
  }
  CloseCurrentLDFFile();
...
int LDFEditor::onActionLIN2_0(void) {
    qWarning() << "onActionLIN2_0 function called";
  if (CheckForSaving() == 0) {
    return 0;
  }
  CloseCurrentLDFFile();
...
qWarning() << "onActionLIN2_1 function called";
  if (CheckForSaving() == 0) {
    return 0;
  }
...
int LDFEditor::onActionHex(void) {
     qWarning() << "onActionHex function called";
...
void LDFEditor::AddWarningsOfNewFile(double dVers) {
     qWarning() << "AddWarningsOfNewFile function called";
  QList<QVariant> ouRow;
  int nRow = 0;
...
int LDFEditor::onActionPreviewFile() {
      qWarning() << "onActionPreviewFile function called";
...
int LDFEditor::nValidateForCluster(list<ParsingResults>& ouErrors,
                                   list<ParsingResults>& ouWarnings) {
      qWarning() << "nValidateForCluster function called";
  // 1. Ecu Validations
