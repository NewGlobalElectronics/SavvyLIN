...
void ScriptContainer::setScriptWindow(ScriptingWindowLIN *win)
{
    window = win;
    connect(this, &ScriptContainer::sendLog, window, &ScriptingWindowLIN::log);
}
...
void CANScriptHelper::gotTargettedFrame(const LINFrame &frame)
{
