...
LINBridgeWindow::LINBridgeWindow(const QVector<LINFrame> *frames, QWidget *parent) :
    QDialog(parent),
    ui(new Ui::LINBridgeWindow)
{
    ui->setupUi(this);
    ...
    connect(ui->cbSide1, &QComboBox::currentTextChanged, this, &LINBridgeWindow::recalcSides);
    connect(ui->cbSide2, &QComboBox::currentTextChanged, this, &LINBridgeWindow::recalcSides);
    connect(MainWindow::getReference(), &MainWindow::framesUpdated, this, &LINBridgeWindow::updatedFrames);
...
LINBridgeWindow::~LINBridgeWindow()
{
    delete ui;
}


void LINBridgeWindow::showEvent(QShowEvent* event)
{
...
bool LINBridgeWindow::eventFilter(QObject *obj, QEvent *event)
{
...
void LINBridgeWindow::recalcSides()
{
...
void LINBridgeWindow::updatedFrames(int numFrames)
{
