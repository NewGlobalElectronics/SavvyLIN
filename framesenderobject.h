...
public:
    FrameSenderObject(const QVector<LINFrame> *frames);
    ~FrameSenderObject();
...
private:
    ...
    QThread*            mThread_p;    
    QHash<int, LINFrame> frameCache; //hash with frame ID as the key and the most recent frame as the value
