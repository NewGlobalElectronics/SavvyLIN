...
At the top you can rename the signal and you'll see that it is renamed in the db window as well.

The majority of the view is taken up by the bitfield grid. This view shows all the signals contained within this message (that have the same multiplexor value as this one). They're all labeled as well. Bonus fun fact - SavvyCAN technically does support CAN-FD db files! That's right, you can load db files with CAN-FD signals and they will work. The bitfield will adjust to show enough bits to show the whole message.
...
"Min Value" is purely informational. It is just a reference to anyone else viewing the db information as to what you expect the lowest value to be.
