...
bool FrameFileIO::saveFrameFile(QString &fileName, const QVector<LINFrame>* frameCache)
{
    QString filename;
...
bool FrameFileIO::loadFrameFile(QString &fileName, QVector<LINFrame>* frameCache)
{
    QString filename;
    QFileDialog dialog;
    QSettings settings;
...
bool FrameFileIO::autoDetectLoadFile(QString filename, QVector<LINFrame>* frames)
{
...
bool FrameFileIO::loadVehicleSpyFile(QString filename, QVector<LINFrame> *frames)
{
    QFile *inFile = new QFile(filename);
    LINFrame thisFrame;
    QByteArray line;
...
bool FrameFileIO::saveVehicleSpyFile(QString filename, const QVector<LINFrame> *frames)
{
    Q_UNUSED(filename);
    Q_UNUSED(frames);
    return true;
...
3-x = The data bytes
*/
bool FrameFileIO::loadCRTDFile(QString filename, QVector<LINFrame>* frames)
{
    QFile *inFile = new QFile(filename);
    LINFrame thisFrame;
    QByteArray line;
...
bool FrameFileIO::loadCARBUSAnalyzerFile(QString filename, QVector<LINFrame>* frames)
{
    QFile *inFile = new QFile(filename);
    if (!inFile->open(QIODevice::ReadOnly))
    {
...
bool FrameFileIO::saveCARBUSAnalzyer(QString filename, const QVector<LINFrame>* frames)
{
...
bool FrameFileIO::loadCANHackerFile(QString filename, QVector<LINFrame>* frames)
{
    QFile *inFile = new QFile(filename);
    LINFrame thisFrame;
    QByteArray line;
...
bool FrameFileIO::loadCANOpenFile(QString filename, QVector<LINFrame>* frames)
{
    QFile *inFile = new QFile(filename);
    LINFrame thisFrame;
    QByteArray line;
...
bool FrameFileIO::saveCRTDFile(QString filename, const QVector<LINFrame>* frames)
{
    QFile *outFile = new QFile(filename);
    int lineCounter = 0;
...
*/
bool FrameFileIO::loadPCANFile(QString filename, QVector<LINFrame>* frames)
{
    QFile *inFile = new QFile(filename);
    LINFrame thisFrame;
    QByteArray line;
...
bool FrameFileIO::loadCanalyzerASC(QString filename, QVector<LINFrame>* frames)
{
    QFile *inFile = new QFile(filename);
    LINFrame thisFrame;
    QByteArray line;
...
bool FrameFileIO::saveCanalyzerASC(QString filename, const QVector<LINFrame>* frames)
{
    QFile *outFile = new QFile(filename);
    int lineCounter = 0;
...
bool FrameFileIO::loadCanalyzerBLF(QString filename, QVector<LINFrame> *frames)
{
    BLFHandler blf;
...
bool FrameFileIO::loadNativeCSVFile(QString filename, QVector<LINFrame>* frames)
{
    QFile *inFile = new QFile(filename);
    LINFrame thisFrame;
    QByteArray line;
...
bool FrameFileIO::saveNativeCSVFile(QString filename, const QVector<LINFrame>* frames)
{
    QFile *outFile = new QFile(filename);
    int lineCounter = 0;
...
bool FrameFileIO::writeContinuousNative(const QVector<LINFrame>* frames, int beginningFrame)
{
...
bool FrameFileIO::loadGenericCSVFile(QString filename, QVector<LINFrame>* frames)
{
    QFile *inFile = new QFile(filename);
    LINFrame thisFrame;
    QByteArray line;
...
bool FrameFileIO::saveGenericCSVFile(QString filename, const QVector<LINFrame>* frames)
{
    QFile *outFile = new QFile(filename);
    int lineCounter = 0;
...
***START DATABASE FILES (DBF/db)***
***END OF DATABASE FILES (DBF/db)***
...
*/
bool FrameFileIO::loadLogFile(QString filename, QVector<LINFrame>* frames)
{
    QFile *inFile = new QFile(filename);
    LINFrame thisFrame;
    QByteArray line;
...
bool FrameFileIO::saveLogFile(QString filename, const QVector<LINFrame>* frames)
{
    QFile *outFile = new QFile(filename);
...
bool FrameFileIO::loadIXXATFile(QString filename, QVector<LINFrame>* frames)
{
    QFile *inFile = new QFile(filename);
    LINFrame thisFrame;
    QByteArray line;
...
bool FrameFileIO::saveIXXATFile(QString filename, const QVector<LINFrame>* frames)
{
    QFile *outFile = new QFile(filename);
    QDateTime timestamp, tempStamp;
    int lineCounter = 0;
    ...
    outFile->write("ASCII Trace IXXAT SavvyLIN V" + QString::number(VERSION).toUtf8() + "\n");
...
bool FrameFileIO::loadCANDOFile(QString filename, QVector<LINFrame>* frames)
{
    QFile *inFile = new QFile(filename);
    LINFrame thisFrame;
    int lineCounter = 0;
...
bool FrameFileIO::saveCANDOFile(QString filename, const QVector<LINFrame>* frames)
{
    QFile *outFile = new QFile(filename);
    int lineCounter = 0;
    QByteArray data;
...
4-x = The data bytes
*/
bool FrameFileIO::loadMicrochipFile(QString filename, QVector<LINFrame>* frames)
{
    QFile *inFile = new QFile(filename);
    LINFrame thisFrame;
    QByteArray line;
...
*/
bool FrameFileIO::saveMicrochipFile(QString filename, const QVector<LINFrame>* frames)
{
    QFile *outFile = new QFile(filename);
    QDateTime timestamp, tempStamp;
    int lineCounter = 0;
    ...
    outFile->write("SavvyLIN Exporter\n");
...
bool FrameFileIO::loadTraceFile(QString filename, QVector<LINFrame>* frames)
{
    QFile *inFile = new QFile(filename);
    LINFrame thisFrame;
    QByteArray line;
...
bool FrameFileIO::saveTraceFile(QString filename, const QVector<LINFrame> * frames)
{
    QFile *outFile = new QFile(filename);
    QDateTime timestamp;
    int lineCounter = 0;
    ...
    outFile->write(";  SavvyLIN CAN Logger trace file\n");
...
bool FrameFileIO::saveCanDumpFile(QString filename, const QVector<LINFrame> * frames)
{
    QFile *outFile = new QFile(filename);
    QDateTime timestamp;
    int lineCounter = 0;
...
/*
   ...
   (1551774790.942758) can1 7A8 [8] F4 DC D1 83 0E 02 00 00
*/
bool FrameFileIO::loadCanDumpFile(QString filename, QVector<LINFrame>* frames)
{
    QFile *inFile = new QFile(filename);
    LINFrame thisFrame;
    QByteArray line;
...
*/
bool FrameFileIO::loadLawicelFile(QString filename, QVector<LINFrame>* frames)
{
    QFile *inFile = new QFile(filename);
    LINFrame thisFrame;
    QByteArray line;
...
//Chn Identifier Flg   DLC  D0...1...2...3...4...5...6..D7       Time     Dir
// 0    000000AD         8  FF  FF  00  00  00  00  00  00     154.266550 R
bool FrameFileIO::loadKvaserFile(QString filename, QVector<LINFrame> *frames, bool useHex)
{
    QFile *inFile = new QFile(filename);
    LINFrame thisFrame;
    QByteArray line;
...
bool FrameFileIO::loadCabanaFile(QString filename, QVector<LINFrame>* frames)
{
    QFile *inFile = new QFile(filename);
    LINFrame thisFrame;
    QByteArray line;
...
bool FrameFileIO::saveCabanaFile(QString filename, const QVector<LINFrame>* frames)
{
    QFile *outFile = new QFile(filename);
    int lineCounter = 0;
...
bool FrameFileIO::loadTeslaAPFile(QString filename, QVector<LINFrame>* frames)
{
    QFile *inFile = new QFile(filename);
    LINFrame thisFrame;
    int lineCounter = 0;
...
bool FrameFileIO::loadCLX000File(QString filename, QVector<LINFrame>* frames) {
    std::unique_ptr<QFile> inFile = std::unique_ptr<QFile>(new QFile(filename));
...
bool FrameFileIO::loadCANServerFile(QString filename, QVector<LINFrame>* frames)
{
    QFile *inFile = new QFile(filename);
    ...
    if (fileIsGood)
    {
        ...
        while (!inFile->atEnd())
        {
            ...
            else if ((logVersion == 1 && data[0] == 0xCD) || (logVersion == 2 && data[0] == 0xD0))
            {
                ...
                /*
                 Log Marks aren't yet supported by SavvyLIN
...
bool FrameFileIO::loadWiresharkFile(QString filename, QVector<LINFrame>* frames)
{
...
bool FrameFileIO::loadWiresharkSocketCANFile(QString filename, QVector<LINFrame>* frames)
{
    pcap_t *pcap_data_file;
    LINFrame thisFrame;
    long long startTimestamp = 0;
