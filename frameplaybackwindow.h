...
namespace Ui {
class FramePlaybackWindowLIN;
}

class FramePlaybackWindowLIN : public QDialog
{
    Q_OBJECT

public:
    explicit FramePlaybackWindowLIN(const QVector<LINFrame> *frames, QWidget *parent = 0);
    ~FramePlaybackWindowLIN();
